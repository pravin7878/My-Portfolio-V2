    ...
    <footer className="bg-[#181818] py-6 px-4 md:px-16 text-center border-t border-gray-800 ">
      <div className="flex flex-col md:flex-row items-center justify-between max-w-4xl mx-auto gap-4">
        <div className='flex gap-4'>
          <button className='text-white hover:text-pink-400 transition cursor-pointer'>About</button>
          <button className='text-white hover:text-pink-400 transition cursor-pointer'>Projects</button>
          <button className='text-white hover:text-pink-400 transition cursor-pointer'>Contact</button>
        </div>
